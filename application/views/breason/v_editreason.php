                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
							<form role="form" action="<?= base_url() ?>admin_reason/update/<?= str_replace(array('+', '=', '/'), array('-', '_', '~'), $this->encryption->encrypt($data->IdReason)) ?>" method="POST" enctype="multipart/form-data">
								<div class="row">
									<div class="col-lg-6">
									<div class="form-group">
										<label>Reason</label>
										<input class="form-control" value="<?= $data->Reason;?>" name="Reason" type="text">
									</div>
									</div>
									<div class="col-lg-6">
									<div class="form-group">
