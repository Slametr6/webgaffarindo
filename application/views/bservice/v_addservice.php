                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
							<form role="form" action="<?= base_url();?>admin_service/action_add/" method="POST" enctype="multipart/form-data">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Service Name</label>
                                            <input class="form-control" placeholder="Input Service Name" name="ServiceName" type="text" required="">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            <label>Icon</label>
											<select class="form-control" name="Icon" type="test" required="">>
