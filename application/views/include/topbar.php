      ...
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="<?= base_url();?>">
            <img src="<?= base_url();?>assets/images/logo/logo-light.png" class="logo-light" alt="logo">
            <img src="<?= base_url();?>assets/images/logo/logo-dark.png" class="logo-dark" alt="logo">
          </a>
